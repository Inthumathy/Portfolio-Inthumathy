  ...
  return (
    <div className="about">
      ...
      <p>
        ...
        passionate about software design, full-stack development, and leveraging modern programming 
      ...
      <div className="education-section">
        <h3>National Diploma in Technology (NDT) — Information Technology</h3>
